...
class AuthorizeNet implements \payments\interfaces\Modules
{
	...
	public function  __construct($amount, $referenceArray, $billingDetails, $settings){
		...
		$defaults = array(
			...
			'x_city'			=> $billingDetails['city'],
			'x_state'			=> $billingDetails['state'],
			'x_zip'				=> $billingDetails['zip'],
			'x_country'			=> $billingDetails['country'],
			'x_email'			=> $billingDetails['email'],
			'x_phone'			=> $billingDetails['phone'],
			'x_card_num'		=> $billingDetails['creditCardNumber'],
			'x_amount'			=> $amount,
			'x_description'		=> $referenceArray['description'],
			'x_exp_date'		=> $billingDetails['creditCardExpDate'],
			'x_card_code'		=> $billingDetails['creditCardCode'],
	...
	protected function forceParameters(){
		if($this->debug){
			$this->fields['x_type'] = 'AUTH_CAPTURE';
	...
	public function returnedResponse(){
        ...
        /**
         * Returns all of the setting names.
         * 
         * @return string
         */
